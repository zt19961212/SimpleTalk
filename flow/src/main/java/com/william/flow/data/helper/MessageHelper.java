...
import com.william.common.utils.PicturesCompressor;
import com.william.common.utils.StreamUtil;
...
import com.william.flow.model.db.Message_Table;
...
public class MessageHelper {
    ...
    public static void push(final MsgCreateModel model) {
       Flow.runOnAsync(new Runnable() {
            ...
            public void run() {
                ...
                Flow.getMessageCenter().dispatch(card);
                ...
                service.msgPush(model).enqueue(new Callback<RspModel<MessageCard>>() {
                    ...
                    public void onResponse(Call<RspModel<MessageCard>> call, Response<RspModel<MessageCard>> response) {
                        ...
                        if (rspModel != null && rspModel.success()) {
                            ...
                            if (rspCard != null) {
                                // 成功的调度
                                Flow.getMessageCenter().dispatch(rspCard);
                            }
                        } else {
                            // 检查是否是账户异常
    ...
    public static Message findLastWithGroup(String groupId) {
        return SQLite.select()
                ...
                .orderBy(Message_Table.createTime, false) // 倒序查询
                .querySingle();
    }
