...
import com.william.common.utils.HashUtil;
...
public class UploadHelper {
    ...
    // 上传的仓库名
    private static final String BUCKET_NAME = "talk-new";


    private static OSS getClient() {
        // 明文设置secret的方式建议只在测试时使用，更多鉴权模式请参考后面的`访问控制`章节
        OSSCredentialProvider credentialProvider = new OSSPlainTextAKSKCredentialProvider(
                "LTAIJqtzvSpRDomr", "tOcmKriuYqMQv4odUNg2s61dkE16so");
        return new OSSClient(Flow.app(), ENDPOINT, credentialProvider);
    }
