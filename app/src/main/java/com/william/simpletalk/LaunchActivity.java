...
import com.william.simpletalk.fragments.permission.PermissionsFragment;
...
public class LaunchActivity extends BaseActivity implements PermissionsFragment.PermissionListener{
    // Drawable
    ...
    public void permissionGranted() {
        ...
        if(fragments!=null&&fragments.size()>0)
            manager.beginTransaction().remove(fragments.get(0));
        skip();
    }
