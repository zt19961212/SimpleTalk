...
import com.william.flow.presenter.contact.PersonalContract;
import com.william.flow.presenter.contact.PersonalPresenter;
...
public class PersonalActivity extends PresenterToolbarActivity<PersonalContract.Presenter>
    ...
    private void changeFollowItemStatus() {
        ...
        // 根据状态设置颜色
        Drawable drawable = mIsFollowUser ? ContextCompat
