package com.william.simpletalk.fragments.permission;
...
private  static PermissionListener listener;
     ...
     * @return 是否有权限
     */
    public static boolean haveAll(Context context, FragmentManager manager,PermissionListener permissionListener) {
